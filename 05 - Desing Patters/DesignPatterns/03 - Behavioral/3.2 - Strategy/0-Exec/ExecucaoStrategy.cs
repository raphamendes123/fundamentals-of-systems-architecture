...
#region Forma Elegante
                ...
                var pedidoCredito2 = 
                    new PedidoService(
                        PagamentoFactory.CreatePagamento(meioPagamentoCredito.MeioPagamento));
...
Console.WriteLine("-------------------------------------------------------");
            ...
            var pedidoBoleto2 = 
                new PedidoService(
                    PagamentoFactory.CreatePagamento(meioPagamentoBoleto.MeioPagamento));
...
Console.WriteLine("-------------------------------------------------------");
            ...
            var pedidoTransferencia2 = 
                new PedidoService(
                    PagamentoFactory.CreatePagamento(meioPagamentoTransferencia.MeioPagamento));
